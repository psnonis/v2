...
1. Nvidia Jetson Xavier PAX (https://developer.nvidia.com/embedded/buy/jetson-xavier-devkit). We are currently testing Nvidia TX2 and you're welcome to give it a shot but we are not actively testing the class materials on it. You've been warned.
